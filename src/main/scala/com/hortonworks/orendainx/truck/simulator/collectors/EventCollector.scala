...
import com.hortonworks.orendainx.truck.simulator.models.Event
 ...
 * However, considering not all EventCollectors may leverage a datastructure that can be accessed concurrently, using actors
